...
$sess1->gc_divisor = 3;
$sess1->start();
$msg = "SHIB1: Files stored in: " . $sess1->get_storage()->getPath();
$msg .= "<br>SHIB1: ID: " . $sess1->id();
if (isset($sess1->data['i'])) {
    $sess1->data['i']++;
} else {
    $sess1->data['i'] = 0;
}
$msg .= "<br>SHIB1: Counter: " . $sess1->data['i'];


session_start();
$msg .= "<br>Native: ID: " . session_id();
if (isset($_SESSION['i'])) {
    $_SESSION['i']++;
} else {
    $_SESSION['i'] = 20;
}
$msg .= "<br>Native: Counter: " . $_SESSION['i'];
...
$msg .= "<br>SHIB2: Counter: " . $sess2->data['i'];



$sess1->regenerate_id(true);
$msg .= "<br>SHIB1: New session ID: " . $sess1->id();

session_regenerate_id(true);
$msg .= "<br>Native: New session ID: " . session_id();

$sess2->regenerate_id(true);
$msg .= "<br>SHIB2: New session ID: " . $sess2->id();
